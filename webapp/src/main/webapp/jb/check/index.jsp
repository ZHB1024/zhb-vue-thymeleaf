...
<div id="app_content" v-cloak style="height: 100%">
    <Layout :style="{padding: '0 24px 24px', height: '100%'}"> 
        <Breadcrumb :style="{margin: '24px 0'}"> 
            ...
            <breadcrumb-item><a href="<%=ctxPath%>/jb/check/index">审核管理</a></breadcrumb-item> 
        </Breadcrumb> 
        <i-content :style="{padding: '24px', minHeight: '428px', background: '#fff'}">
            <i-form inline method="post">
                
                <form-item prop="organizationId">
                    <i-select name="organizationId" clearable v-model="formParm.organizationId" @on-change="getEmployees" style="width: 150px;" placeholder="请选择组织">
                ...
                <form-item prop="creator">
                    <i-select name="creator" clearable v-model="formParm.creator" style="width: 150px;" placeholder="请选择人员">
            ...
            <div style="margin-bottom: 10px;">
                <Date-picker class="select-dates" type="daterange"  name="workdate"  :start-date="startDate" v-model="formParm.workdate"  format="yyyy-MM-dd"  placeholder="请选择审核日期范围时间段">
                </Date-picker>  
        ...
        columns1:[
            ...
            
            {
                ...
                render: (h, params) => {
                    return h("div", {
                        domProps: {
                          innerHTML: params.row.worRecords
                        }
                      });
                }
            },
